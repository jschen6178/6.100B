...
class State():
    def __init__(self, abbreviated_name, dem, rep, ec):
        """
        Parameters:
        abbreviated_name - the 2 letter abbreviation of a state
        dem - number of Democrat votes cast
        rep - number of Republican votes cast
        ec - number of EC votes a state has

        Attributes:
        self.abbreviated_name - str, the 2 letter abbreviation of a state
